...
// Tx returns a wrapped transaction (vclutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (vclutil.Tx) for all
...
// instead provides easy access to wrapped versions (vclutil.Tx) of them.
