...
func (k *ExtendedKey) Derive(i uint32) (*ExtendedKey, error) {
	...
	parentFP := vclutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*vclutil.AddressPubKeyHash, error) {
	pkHash := vclutil.Hash160(k.pubKeyBytes())
	return vclutil.NewAddressPubKeyHash(pkHash, net)
}
