...
func NewCoin(index int64, value vclutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = vclutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = vclutil.NewTxFromBytes(testSimpleCoinTxBytes)
